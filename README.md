...
CI calculated with stderr=Homoskedastic: (0.013, 0.395)
CI calculated with stderr=Robust (HC3): (0.013, 0.394)
CI calculated with stderr=Clustered By Dev: (0.016, 0.39)
```
...
- `ai_treatment`: 0 if AI was not allowed on this issue. 1 if AI was allowed on this issue.
